        ...
        <main>
            <div className="row">
                <div className="col-lg-7 col-sm-12 text-center col-md-8 ">
                    <div className='animate__animated animate__fadeIn fs-5 d-flex flex-wrap align-items-center justify-content-center'><h1 className='animate__animated animate__fadeInLeftBig'>4</h1><h1 className='animate__animated animate__fadeInUpBig'>0</h1><h1 className='animate__animated animate__fadeInRightBig'>4</h1></div>
                    <img src={img4} alt="404 NOT FOUND" width="539.22px" height="447.43px" className="img-fluid animate__animated animate__zoomInRight"  srcset=""/>
                </div>
